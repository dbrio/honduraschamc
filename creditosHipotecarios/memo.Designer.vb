...
Namespace memoTableAdapters
    ...
    Partial Public Class MemoAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As memo.MemoDataTable, ByVal memoId As Integer) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal memoId As Integer) As memo.MemoDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(memoId,Integer)
